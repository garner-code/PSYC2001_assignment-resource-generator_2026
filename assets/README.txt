...
The script contains all the code required to load the data, perform visualisations, run a paired sample t-test between v1 and v2, run a between groups t-test for v1, and also for v2, as well as a correlation analysis between v1 and v2.
